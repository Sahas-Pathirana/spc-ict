...
const Home = () => {
  const competitions = [
    {
      ...
      description:
        "Create stunning digital experiences with modern web technologies. Showcase your skills in responsive design, user experience, and innovative digital solutions.",
    ...
    },
    {
      ...
      description:
        "Design and develop cutting-edge mobile applications that solve real-world problems. Focus on user-centric design and seamless functionality.",
    ...
    },
    {
      ...
      description:
        "Create secure and user-friendly digital identity solutions. Explore blockchain, biometrics, and advanced authentication methods.",
    ...
    },
    {
      ...
      description:
        "Integrate artificial intelligence into practical applications. Demonstrate innovation in machine learning, natural language processing, and automation.",
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Shape the future of digital identity through innovation,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Discover exciting opportunities to showcase your skills and
              compete with the best minds in digital innovation.
            </p>
          </div>
            ...
            {competitions.map((competition) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div
                    className={`flex-shrink-0 p-2 rounded-xl bg-gradient-to-r ${competition.color} text-white shadow-lg`}
                  >
                    {competition.icon}
                  </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-gray-900 to-blue-900 text-white z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to Make Your Mark?
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join our community of innovators and showcase your digital identity
